...
from config import *
from dp_stp import adaptive_grid_construction_main
from dp_stp import mobility_model_main
from dp_stp import prune_density
from dp_stp import prune_direction
from dp_stp import route_length_estimate_main
from dp_stp import synthetic_generate_trajs
from dp_stp import trip_distribution_main
...
def run(epsilon):
    ...
    n_grid = adaptive_grid_construction_main(
    ...
    synthetic_generate_trajs(grid_tree_path=grid_tree_path.format(USE_DATA, epsilon),
                             ...
                             sd_desensitization_path=sd_desensitization_path.format(USE_DATA, epsilon),
