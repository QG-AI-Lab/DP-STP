...
from dp_star import synthetic_generate_trajs
...
def run(epsilon):
    ...
    synthetic_generate_trajs(n_grid, maxT, trip_distribution_path.format(USE_DATA, epsilon),
